...
featured: false
ogImage: "/src/assets/images/og/butterfly-pale-blue.jpg"
tags:
  - produktywnosc
  - praca-zdalna
  - prokrastynacja
...
<Callout>
  _Deep work_ to fancy określenie na wyłączenie TikToka i skupieniu się na robocie 💀.\
...
<Callout>
Temat wpisuje się w moje ostatnie większe zainteresowanie automatyzacją i ogólnie lepszym zarządzaniem swoim czasem, tak że na pewno pojawią się jeszcze apki i programy, które od niedawna regularnie uruchamiane są równolegle z Freedom. Sprawdź na przykład [Make](/wpisy/make-doskonale-narzedzie-do-automatyzacji).
</Callout>
