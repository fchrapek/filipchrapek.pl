---
title: Automatyzacja nudnych zadań z Make! Wystawiaj i wysyłaj faktury jednym przyciskiem myszy — Make + Notion + Infakt API
...
tags:
  ...
  - infakt
  - api
description: "Sprawdź receptę na uwolnienie się od żmudnej buchalterii! Nie trać czasu na ręczne tworzenie i wysyłanie faktur. Zleć to robotowi, niech się męczy."
---
...
import makeScenario from "../../assets/images/3/make-scenario.png";
import notionTasks from "../../assets/images/3/notion-tasks-structure.png";
import makeNotionFilter from "../../assets/images/3/make-notion-filter.png";
import makeHttpCreate from "../../assets/images/3/make-http-infakt-create.png";
import makeHttpSend from "../../assets/images/3/make-http-infakt-send.png";
import makeNotionUpdateDatabase from "../../assets/images/3/make-notion-update-database-item.png";
...
Pora przywdziać ciężką, ceremonialną togę, zarzucić ogromny kaptur, zapalić 2 ceremonialne świecie i rozpocząć przerażający rytuał buchalterii.
...
<Callout>
  ...
  nie zrobiłeś, [tutaj](/wpisy/jak-wygenerować-klucz-api-w-infakt) sprawdzisz
