...
Wystartował <LinkExternal href="https://www.aidevs.pl/">kurs</LinkExternal> Adama Gospodarczyka, Kuby Mrugalskiego i Mateusza Chroboka i rąsie aż same zacierają się z podekscytowania.
...
Pierwsza lekcja to dosyć obszerny wstęp opisujący Duże Modele Językowe – czym są oraz dlaczego są spoko i niespoko. Wprowadzonych zostaje też sporo pojęć (np. <LinkExternal href="https://www.aidevs.pl/">halucynacja modelu</LinkExternal>) oraz narzędzi związanych mniej lub bardziej z generative AI. Linkowane są też źródła, tak że w dwóch słowach – jest dobrze!
